...
const items: Article[] = [
  ...
  // },
  {
    ...
    content: md.render(require('raw-loader!' + './00.开篇寄语：Angular —— 王者归来/_index.md')),
    first: true,
    column: '雪狼湖',
    tags: ['现在'],
    authors: ['雪狼']
...
export class ArticleApi {
  static items: Article[] = items;

  /**
   * return Observable<Article[]> filtered by hidden, author, tag, column
   */
  static query(params: {author?: string, tag?: string, column?: string}): Observable<Article[]> {
